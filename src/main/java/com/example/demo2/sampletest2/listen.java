...
//  ITestListener.super.onTestFailure(result);  System.out.println(result);
 }
...
//  ITestListener.super.onTestFailedButWithinSuccessPercentage(result);  System.out.println(result);
 }
